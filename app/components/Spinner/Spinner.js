...
function getSpinnerBackgroundStyle(spinnerType, customButtonStyle, defaultButtonStyle) {
      ...
      return (
        <View
          ...
          <Animatable.View
            ...
            <DotIndicator color={spinnerColor || 'rgb(255, 255, 255)'} count={indicatorCount} size={size} />
          </Animatable.View>
        </View>
      );
    case 'MaterialIndicator':
